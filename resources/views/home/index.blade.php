...
{{--        @endforeach--}}
{{--        <div class="dropdown-divider"></div>--}}
{{--        <a href="{{ route('notifications.markAllRead') }}" class="dropdown-item dropdown-footer">Marquer tout comme lu</a>--}}
{{--    </div>--}}
{{--</li>--}}
//////
...
<!--          notifications -->
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                @if(auth()->check())
                                    ...
                                    @forelse(auth()->user()->notifications as $notification)
                                        @php
                                            $message = $notification->data['message'] ?? 'Message indisponible';
                                        @endphp
                                        <a href="{{ route('notifications.show', $notification->id) }}" class="dropdown-item @if(is_null($notification->read_at)) unread-notification @else read-notification @endif">
                                            {{ $message }}
                                            <span class="text-muted text-sm">{{ $notification->created_at->diffForHumans() }}</span>
                                        </a>
                                    @empty
                        ...
                        <style>
                            /* Couleur de fond pour les notifications non lues (comme Facebook) */
                            .unread-notification {
                                background-color: #E7F3FF; /* Bleu clair similaire à Facebook */
                            }

                            /* Couleur de fond pour les notifications lues */
                            .read-notification {
                                background-color: #ffffff; /* Blanc pour les notifications lues */
                            }
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="d-flex flex-column">
                                                <div class="mb-2">
                                                    ...
                                                    @else
                                                        <small class="text-muted">Utilisateur non authentifié</small>
                                                    @endif
                                                </div>
                                                <div>
